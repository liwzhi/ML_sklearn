...
df_train = pd.read_csv('Desktop/Weizhi/input/train.csv', encoding="ISO-8859-1")
df_test = pd.read_csv('Desktop/Weizhi/input/test.csv', encoding="ISO-8859-1")
df_pro_desc = pd.read_csv('Desktop/Weizhi/input/product_descriptions.csv')
df_attr = pd.read_csv('Desktop/Weizhi/input/attributes.csv')
